...
export default function PremiumBoard3D({ onBack }: Props) {
  ...
  return <div data-performance-profile="premium-3d" data-game-state={game.session.state} className={`premium-page-v14 qqurz-content-page three-play-page ${showClock ? 'clock-visible' : 'clock-hidden'}`}>
