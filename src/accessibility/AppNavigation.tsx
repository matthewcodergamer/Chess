...
type NavIconName = 'menu' | 'home' | 'trophy' | 'users' | 'cube' | 'user' | 'sun' | 'board' | 'sound' | 'type' | 'accessibility';
  ...
  return <>
    ...
    <header className="qqurz-nav chess-topbar">
      ...
      <button className="qqurz-wordmark" onClick={() => run(onHome)} aria-label="qqurzchess home">
        <span className="wordmark-pawn" aria-hidden="true"><NavIcon name="user" /></span><span className="wordmark-copy"><b>qqurzchess</b></span>
      </button>
