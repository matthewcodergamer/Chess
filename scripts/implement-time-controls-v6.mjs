...
const temp = '/tmp/qqurz-implement-time-controls-v6.mjs';
...
if (!responsive.includes('.time-control-pills{grid-template-columns:repeat(2,minmax(0,1fr))}')) responsive += `\n@media(max-width:560px){.time-control-pills{grid-template-columns:repeat(2,minmax(0,1fr))}}\n`;
fs.writeFileSync(responsivePath, responsive);

const arenaPath = 'src/multiplayer/OnlineArena.tsx';
